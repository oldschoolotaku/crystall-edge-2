...
[DataDefinition]
public sealed partial class CEStackGroupConstructionGraphStep : EntityInsertConstructionGraphStep
{
    [DataField]
    public ProtoId<CEStackGroupPrototype> StackGroup = default!;
